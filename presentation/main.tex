% !TEX root = /workplaces/ecc_talc/presentation/main.tex
  ...
  \section{Основная часть}
    \subsection{Конечные поля}
      \subsubsection{Определение}
        \input{main/fields/definition}
        \input{main/fields/operations}
        \input{main/fields/rules}
      \subsubsection{Зачем они нужны}
        \input{main/fields/purpose}
    \subsection{Эллиптические кривые}
      \subsubsection{Определение}
        \input{main/curves/definition}
      \subsubsection{Арифметика точек}
        \input{main/curves/math_principles}
        \input{main/curves/infinitely_point}
        \input{main/curves/self_add}
    \subsection{Скрещиваем}
      \subsubsection{Определение}
        \input{main/hybrid/line_ander_field}
        \input{main/hybrid/curve_ander_field}
      \subsubsection{Скалярное умножение}
        \input{main/scalar_multiplication/graphically}
        \input{main/scalar_multiplication/ander_field}
    \subsection{Криптография}
      \subsubsection{Определение}
        \input{main/crypto/cryptographic_curve_def}
        \input{main/crypto/cryptographic_keys}
        \input{main/crypto/cryptographic_curve_comparison}
      \subsubsection{Подписание и верификация}
        \input{main/crypto/signature}

  \section{Заключение}
    \subsection{Квантовый компьютер}
      \input{conclusion/quantum}
    \subsection{АНБ}
      \input{conclusion/nsa}
